    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input wire:model="Ubicacion" type="text" class="form-control" id="Ubicacion" placeholder="Ubicación">@error('Ubicacion') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
