            ...
            <div class="row">
                ...
                <div class="col-md-5">
                    ...
                    <div class="bg-light border rounded-3">
                        <br><br><br><br><br><p class="text-muted">
                            <p class="text-center">
                        ...
                        <form wire:submit.prevent="store" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input wire:model="FechaFin" type="date" 
                                     id="FechaFin" class="form-control @error('FechaFin') is-invalid @enderror" > 
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    class="form-control @error('HorarioInicio') is-invalid @enderror" id="HorarioInicio" 
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input wire:model.defer="HorarioFin" type="time" 
                                        class="form-control @error('HorarioFin') is-invalid @enderror" 
                                        id="HorarioFin"
