        ...
        <div class="modal-content">
           ...
           <div class="modal-body">
			<form wire:submit.prevent="store" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="form-group col-5">
                        ...
                        <input wire:model="FechaInicio" type="date" id="FechaInicio" class="form-control" >@error('FechaInicio') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group col-5">
                        <label for="fechafin"><span>Fecha final</span></label>
                ...
                <div class="row">
                    <div class="form-group col-5">
                        ...
                        <input wire:model="HorarioInicio" type="time" class="form-control" id="HorarioInicio" placeholder="HorarioInicio">@error('HorarioInicio') <span class="error text-danger">{{ $message }}</span> @enderror
                    </div>
                    <div class="form-group col-5">
            ...
            <div class="modal-footer">
                ...
                <button type="button" wire:loading.attr="disabled" wire:target="imagen" wire:click.prevent="store()" class="btn btn-primary close-modal">Guardar</button>
            </div>
        </div>
    </div>
</div>