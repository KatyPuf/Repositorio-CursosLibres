						...
						<div class="col">
							<div class="card h-100">
									...
									<p class="card-text">
										...
										<div class="row">
											...
											<div class="col-md-2">
												...
												<a href="" data-toggle="modal" data-toggle="tooltip" data-placement="bottom" title="Ver"
													data-target="#verEstudiantes" data-id="{{$row->id}}" class="text-muted" >
								...
								<div class="card-footer text-muted">
									...
									<div class="btn-group">
										<?php $cantidad = Planificaciones::VerificarInscripcion($row->id)  ?> <!-- contador de inscripciones-->
