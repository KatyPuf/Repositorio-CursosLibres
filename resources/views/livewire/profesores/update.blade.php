    ...
    <div class="modal-dialog" role="document">
       <div class="modal-content">
            ...
            <div class="form-group">
                ...
                <input wire:model="EmpresaTelefonica" type="text" class="form-control" id="EmpresaTelefonica" placeholder="Empresa teléfonica">@error('EmpresaTelefonica') <span class="error text-danger">{{ $message }}</span> @enderror
            </div>
